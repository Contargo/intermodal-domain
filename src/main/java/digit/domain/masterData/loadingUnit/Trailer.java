 ...
 * @DIGIT_definition_german  Anhängerfahrzeug, bei dem anstelle der bei Gelenk-Deichselanhägern vorhandenen ersten
 *                           Achse eine Sattelvorrichtung angeordnet ist und ein wesentlicher Teil seines
 *                           Gesamtgewichts auf eine Sattelzugmaschine übertragen wird. (@see DIN 70010:2001, 2.3 —
 *                           modifiziert, „(siehe 1.2.2.3.2) (auch Deichselachse (Dolly))“ gestrichen, Anmerkung 1
 *                           hinzugefügt)
