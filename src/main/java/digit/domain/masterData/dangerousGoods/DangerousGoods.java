 ...
 * @DIGIT_annotation  Bei verschiedenen Verkehrsträgern kommt das entsprechende Regelwerk zum Tragen.
 * @DIGIT_annotation_english  There are different rules for different modes of transport.
 */
