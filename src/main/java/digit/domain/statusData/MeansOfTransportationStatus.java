 ...
 *                     Konkretisierung was genau zu welchem Zeitpunkt passiert. Begleitinformationen beim
 *                     Verkehrsmittel betreffen die Transportrelation.
 * @definition_english  Status of means of transport for communication flow of intermodal freight transport. The means
 *                      of transportation status and {@link digit.domain.statusData.StatusLU loading unit status}
...
public class MeansOfTransportationStatus {
     ...
     *                     {@link digit.domain.masterData.meansOfTransport.MeansOfTransport VM} beim Verlassen des
     *                     Umschlagpunktes.
     */
    private Date atd;
     ...
     * @definition_german  Geplante Ankunft des {@link digit.domain.masterData.meansOfTransport.MeansOfTransport VM} am
     *                     Umschlagpunkt.
     */
    private Date eta;
     ...
     * @definition_german  {@link digit.domain.masterData.meansOfTransport.MeansOfTransport VM} ist bereit für den
     ...
     * @definition_german  {@link digit.domain.masterData.meansOfTransport.MeansOfTransport VM} beladen, Ende Verladung
