 ...
 *                           reibungsloser Austausch zwischen den Akteuren sichergestellt werden. Prinzipiell sollten
 *                           die beiden Status als Paket verstanden werden. Die Kerndaten sind jeweils immer gleich und
 *                           werden durch den jeweiligen Status konkretisiert. Dabei gibt es zwei Blöcke pro
 ...
 *                           Begleitinformationen bei der Ladeeinheit betreffen beispielsweise den Auftrag.
...
public class StatusLU {
     ...
     *
     * @DIGIT_name_german  Verladebereit
     * @DIGIT_definition_german  {@link digit.domain.masterData.loadingUnit.LoadingUnit Ladeeinheit} ist bereit für den
     ...
     *
     * @DIGIT_name_german  Verladen
     * @DIGIT_definition_german  {@link digit.domain.masterData.loadingUnit.LoadingUnit Ladeeinheit} ist umgeschlagen
     *                           und befindet sich auf dem
     *                           {@link digit.domain.masterData.meansOfTransport.MeansOfTransport VM}.
     */
     ...
     * Ready for going out.
     *
     * @DIGIT_name_german  Ausgangskontrolle
     * @DIGIT_definition_german  {@link digit.domain.masterData.loadingUnit.LoadingUnit Ladeeinheit} ist gesichtet und
     ...
     *
     * @DIGIT_name_german  Ausgegangen
     * @DIGIT_definition_german  {@link digit.domain.masterData.loadingUnit.LoadingUnit Ladeeinheit} ist verladen und
     ...
     * Ready for going in.
     *
     * @DIGIT_name_german  Eingangskontrolle
     * @DIGIT_definition_german  {@link digit.domain.masterData.loadingUnit.LoadingUnit Ladeeinheit} gesichtet, auf
     *                           {@link digit.domain.masterData.meansOfTransport.MeansOfTransport VM} mit dem
     ...
     *
     * @DIGIT_name_german  Eingegangen
     * @DIGIT_definition_german  {@link digit.domain.masterData.loadingUnit.LoadingUnit Ladeeinheit} ist auf
     *                           {@link digit.domain.masterData.meansOfTransport.MeansOfTransport VM} im
     *                           Umschlagbereich.
     */
    private boolean in;
     ...
     * {@link digit.domain.masterData.meansOfTransport.MeansOfTransport MoT} present.
     *
     * @DIGIT_name_german  Entladebereit
     * @DIGIT_definition_german  {@link digit.domain.masterData.loadingUnit.LoadingUnit Ladeeinheit} auf
     *                           {@link digit.domain.masterData.meansOfTransport.MeansOfTransport VM} und im
     ...
     *
     * @DIGIT_name_german  Entladen
     * @DIGIT_definition_german  {@link digit.domain.masterData.loadingUnit.LoadingUnit Ladeeinheit} vom
