 ...
 * corporation. This typically means that the {@link Terminal} has an identity and is referred to, not only as a
 * geographical location, as an <i>actor</i> in the system. For example, business events and messages typically stems
 * from one of many {@link Terminal terminals} and roles or groups are also often bound to a specific {@link Terminal}.
 * </p>
 *
