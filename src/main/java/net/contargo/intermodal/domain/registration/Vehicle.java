 ...
 *                      {@link Driver Person} and {@link net.contargo.intermodal.domain.loadingUnit.Order}. It is valid
 *                      for the delivery of loading units as well as for the pick up of an loading unit on a handling
 *                      point.
