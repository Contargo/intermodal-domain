...
/**
 * Defines the transportation from a well defined starting point or source to a end destination, performed by some
 ...
 * Startpunkt und Endpunkt gibt. Zu einer Teilstrecke gehören unter anderem Informationen über die beteiligten
 * Standorte (Start, Ziel), den transportierten Container und das transportierende Verkehrsmittel. Jede Teilstrecke
 * kann eindeutig einer Position eines Auftrags zugeordnet werden. Im zeitlichen Verlauf existiert eine Teilstrecke in
 * den verschiedenen Phasen der Auftragsdurchführung in verschiedenen Zuständen, je nachdem ob sie in Planung ist, oder
 * sich in oder nach der Durchführung befindet.
 */
